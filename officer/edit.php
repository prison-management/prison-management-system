...
$Nid = $_POST['Nid'];
$From = $mysqli -> real_escape_string(htmlspecialchars($_POST['Form']));
$To = $mysqli -> real_escape_string(htmlspecialchars($_POST['To']));
$dateoftransfer = $mysqli -> real_escape_string(htmlspecialchars($_POST['dateoftransfer']));
...
mysqli_query($con, "UPDATE transfer SET File_Num='$Filenum', From_prison='$From', 
...
//user the second
$result = mysqli_query($con, "SELECT * FROM transfer WHERE id=$National_id")
or die(mysqli_error($con));
