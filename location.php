<html>
<head>
  <title>KERALA PRISONS SERVICE</title>
            ...
            <td colspan="7" bgcolor="#yellow" height="1" align="center">
		      <h1><font size="5">
	           <a href="index.php">Home</a> | 
		        ...
		        <a href="admin/search-form.php">Search </a>
		        <a href="location.php">Location</a>|
		        <a href="announce.php">Complain</a>|
				 <a href="admin/transfer.php">Prisoner Trans </a> ||
		        <a href="admin/officertransfer.php">Officer</a>|
		        <a href="admin/registration.php">Register</a>
				<a href="admin/court.php">Court</a>
		        </font></h1>
            </td>
			 </td>
...
<ul>
<li><a href='admin/viewofficer.php'><b>View Officer  Transfer</b></a></li>
		<br>
	<li><a href='admin/viewprisoners.php'><b>Prisoners Information Display</b></a></li>
		<br>
		<li><a href='admin/viewcase.php'><b>Case Information View</b></a></li>
		<br>
	<li><a href='admin/viewtransfer.php'><b>Prisoners Transfer Information</b></a></li>
		<br>
	<li><a href='admin/viewAnnounce.php'><b>View Comment</b></a></li>
		<br>
